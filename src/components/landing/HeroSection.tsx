...
import { Warehouse, Users, BarChart3, Shield } from "lucide-react";
    ...
    <section className="relative min-h-screen flex items-center justify-center gradient-hero overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="animate-float mb-8">
          <img src={logo} alt="مدار" className="h-32 md:h-40 mx-auto" />
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <Link to="/register/company" className="px-8 py-3.5 text-base font-bold rounded-xl gradient-primary text-primary-foreground shadow-glow hover:opacity-90 transition-all">
            ابدأ تجربتك المجانية
          </Link>
          <a href="#features" className="px-8 py-3.5 text-base font-bold rounded-xl border border-border hover:border-primary/50 text-foreground transition-all">
            اكتشف المميزات
          </a>
        </div>
